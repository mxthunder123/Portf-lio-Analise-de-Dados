...
Abaixo está o meu projeto principal, que demonstra a capacidade de adaptar a análise e visualização a diferentes públicos e necessidades.

### 1. 🌟 Carpe Diem: Análise de Desempenho Escolar (Alunos Neurodivergentes)

**Resumo do Projeto:**
O **Carpe Diem** é uma ferramenta de Business Intelligence (BI) desenvolvida para transformar dados brutos de desempenho e comportamento escolar em *insights* direcionados, apoiando a gestão e o acompanhamento de alunos neurodivergentes.

O projeto demonstra a capacidade de criar sistemas de relatórios que atendem a **três públicos com necessidades de informação totalmente distintas** (Pais, Professores e Gestores), garantindo que cada um receba as métricas mais relevantes para suas decisões.

#### **Dashboards e Acesso Online:**
